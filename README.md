...
###Data
The selected coordinates is displaying as a data value of a hidden input ``#selectCoords``. To get this values use ``$selectCordsDt`` object. 

Also use ``console.dir($selectCordsDt);`` to see it at the browser console.
